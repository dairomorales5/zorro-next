...
import { audioTranscription, JSONUpdate, fetchOpenAIStream, streamReader } from './js/openai';
...
const AudioRecorder = () => {
  const {setTranscribiendo,mensajes, setMensajes, createSystemMessage, agregarMensaje, json,setJson, typing} = useConversacion();
  ...
  const $canvas = typeof document !== 'undefined' ? document.querySelector('.audio-react-recorder>canvas') : null;
